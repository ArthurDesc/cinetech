    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
        <x-magic-card class="relative overflow-hidden rounded-2xl transition-all duration-300 group w-full sm:max-w-md mt-6 px-4 py-8 bg-black shadow-2xl ring-2 ring-orange-700/30 rounded-2xl relative mx-2">
            ...
            <div class="flex flex-col items-center mb-4">
                ...
                <h2 class="text-3xl font-bold text-center text-white mb-1">{{ __('Connexion') }}</h2>
                <p class="text-center text-gray-300 text-sm mt-1">Tes informations sont protégées et confidentielles.</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="email" class="block mt-1 w-full bg-gray-700 border border-gray-600 text-white pl-3 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center mt-6 gap-2 sm:gap-4 w-full">
                    <div class="flex flex-row items-center justify-center w-full">
                        @if (Route::has('password.request'))
                            <a class="text-sm text-gray-300 hover:text-white hover:underline rounded-md  px-2" href="{{ route('password.request') }}">
