        ...
        <x-magic-card class="relative overflow-hidden rounded-2xl transition-all duration-300 group w-full sm:max-w-md mt-6 px-4 py-8 bg-black shadow-2xl ring-2 ring-orange-700/30 rounded-2xl relative mx-2">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="nickname" name="nickname" type="text" class="block mt-1 w-full bg-gray-700 border border-gray-600 text-white pl-3 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition" :value="old('nickname')" required autofocus autocomplete="nickname" />
